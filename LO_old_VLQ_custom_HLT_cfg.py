...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:LO_old_VLQ_custom_DIGIPremix.root'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:LO_old_VLQ_custom_HLT.root'),
