...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:LO_old_VLQ_custom_RECO.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:LO_old_VLQ_custom_MiniAOD.root'),
